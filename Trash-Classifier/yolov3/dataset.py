...
class Dataset(object):
    ...
    def load_annotations(self, dataset_type):
        ...
        for annotation in annotations:
            ...
            #print(" ")
            #print("dataset.py def Load_Annotations  Annotation:  ",annotation)
            #print(" ")
            #line = annotation.split(" ",6)
    ...
    def parse_annotation(self, annotation, mAP = 'False'):
        ...
        #print("dataset.py def Parse_anno")
        #print(" ")
        #print("annotation:  not printing because of img data in spot 2")#,annotation)
        #print(" ")
        #print("annotation[0]:  ",annotation[0])
        #print(" ")
        #print("annotation[1]:  ",annotation[1])
        #print(" ")
        #print("annotation[2]:  "+"Image Data") #, annotation[2])
        #print(" ")
